...
void nunchuk_init()
	...
	Wire1.begin();
	delay(1);
	Wire1.beginTransmission(0x52);  // device address
	Wire1.write((uint8_t)0xF0);  // 1st initialisation register
	Wire1.write((uint8_t)0x55);  // 1st initialisation value
	Wire1.endTransmission();
	delay(1);
	Wire1.beginTransmission(0x52);
	Wire1.write((uint8_t)0xFB);  // 2nd initialisation register
	Wire1.write((uint8_t)0x00);  // 2nd initialisation value
	Wire1.endTransmission();
	delay(1);
	//
...
{
	Wire1.beginTransmission(0x52);// transmit to device 0x52
	Wire1.write((uint8_t)0x00);// sends one byte
